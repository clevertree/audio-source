        ...
        switch(menuKey) {
            case 'root':
                ...
                return (<>
                    ...
                    <SubMenu vertical={vertical} key="playlist"    options={e => this.renderMenu('playlist')}  >Playlist</SubMenu>
            ...
            case 'file':
                return (<>
                    <SubMenu key="memory"      options={e => this.renderMenu('file-memory')}      >Load from Memory</SubMenu>
